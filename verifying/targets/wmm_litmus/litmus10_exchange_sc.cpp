...
struct Exp10Spec {
  using method_t = std::function<ValueWrapper(Exp10Spec *, void *)>;
  static auto GetMethods() {
    method_t func = [](Exp10Spec *, void *) -> ValueWrapper { return void_v; };
...
using spec_t =
    ltest::Spec<Exp10Test, Exp10Spec, LinearWmmHash, LinearWmmEquals>;
