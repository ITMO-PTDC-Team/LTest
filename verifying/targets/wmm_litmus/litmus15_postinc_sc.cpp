...
struct Exp15Spec {
  using method_t = std::function<ValueWrapper(Exp15Spec *, void *)>;
  static auto GetMethods() {
    method_t func = [](Exp15Spec *, void *) -> ValueWrapper { return void_v; };
...
using spec_t =
    ltest::Spec<Exp15Test, Exp15Spec, LinearWmmHash, LinearWmmEquals>;
