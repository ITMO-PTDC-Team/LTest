...
struct Exp21Spec {
  using method_t = std::function<ValueWrapper(Exp21Spec *, void *)>;
  static auto GetMethods() {
    method_t func = [](Exp21Spec *, void *) -> ValueWrapper { return void_v; };
...
using spec_t =
    ltest::Spec<Exp21Test, Exp21Spec, LinearWmmHash, LinearWmmEquals>;
