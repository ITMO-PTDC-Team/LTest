...
struct Exp22Spec {
  using method_t = std::function<ValueWrapper(Exp22Spec *, void *)>;
  static auto GetMethods() {
    method_t func = [](Exp22Spec *, void *) -> ValueWrapper { return void_v; };
...
using spec_t =
    ltest::Spec<Exp22Test, Exp22Spec, LinearWmmHash, LinearWmmEquals>;
